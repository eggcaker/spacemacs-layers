...
(defconst pelm-music-packages
  '(emms))

(defun pelm-music/init-emms ()
  (use-package emms
    :defer t
    :commands emms
    :config
    (progn
      ...
      (setq emms-score-file "~/.emacs.d/.cache/emms/scores"
            emms-stream-bookmarks-file "~/.emacs.d/.cachej/emms/emms-streams"
            emms-history-file "~/.emacs.d/.cache/emms/emms-history"
            emms-cache-file "~/.emacs.d/.cache/emms/emms-cache"
            emms-source-file-default-directory "~/Music/Emacs/")
...
(defun pelm-music/init-soundklaus ()
